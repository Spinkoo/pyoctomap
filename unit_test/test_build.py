...
"""
    ...
    # Check conversions
    assert (
        "https://github.com/Spinkoo/pyoctomap/blob/main/images/test.png?raw=true"
        in result
    ), "Image URL not converted correctly"
    assert "https://github.com/Spinkoo/pyoctomap/blob/main/docs/guide.md" in result, (
        "Link URL not converted correctly"
    )
