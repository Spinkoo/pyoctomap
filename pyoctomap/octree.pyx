...
cdef class OcTree:
    ...
    def insertPointCloud(self,
                     ...
                     method="default"):
        """
        Batch insertion with different algorithm options.
        ...
        Args:
            ...
            discretize: If True, discretize points to keys first (only applies to "default" method)
            method: "default" (builds KeySet of free cells, deduplicating rays) or 
                    "rays_fast" (raw parallel rays without KeySet deduplication)
        ...
        if method == "default":
        ...
        elif method == "rays" or method == "rays_fast":
            ...
            raise ValueError(f"Unknown insertion method: {method}. Use 'default' or 'rays_fast'.")
    ...
    def insertPointCloudRaysFast(self,
                                ...
                                bint lazy_eval=False):
        """
        DEPRECATED: Use insertPointCloud(..., method="rays_fast") instead.
        """
        import warnings
        warnings.warn("insertPointCloudRaysFast is deprecated. "
                      "Use insertPointCloud(..., method=\"rays_fast\") instead.",
                      DeprecationWarning, stacklevel=2)
        return self.insertPointCloud(point_cloud, sensor_origin, 
                                     max_range=max_range, lazy_eval=lazy_eval, 
                                     method="rays_fast")
